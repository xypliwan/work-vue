...
<<<<<<< HEAD
            ...
            >
              <el-option
                v-for="(item, i) in filterData.statusList"
                :key="i"
...
<<<<<<< HEAD
        ...
        <el-col :span="11">
          <el-form-item label="需求模块" prop="model_id">
            ...
            >
              <el-option
                v-for="(item, i) in filterData.model"
                :key="i"
...
<<<<<<< HEAD
        ...
        <el-col :span="11" :offset="2">
          <el-form-item
            label="责任人"
            prop="deal_user_id"
            v-show="filterData.dealUser.length > 0"
          >
            <el-select
              v-model="ruleForm.deal_user_id"
              placeholder="请选择"
              filterable
              clearable
            >
              <el-option
                v-for="(item, i) in filterData.dealUser"
                :key="i"
                :label="item.username"
                :value="item.user_id"
              ></el-option>
      ...
      <el-row>
        <el-col :span="11">
          <el-form-item
            label="所属公司"
            prop="extend_deal_company_id"
            v-show="filterData.company == 1"
          >
            <el-select
              v-model="ruleForm.extend_deal_company_id"
              @change="changeCompany"
...
<<<<<<< HEAD
      ...
      selectTime: [],
      timeType: [
        { title: '需求发起时间', index: 'created_at' },
        { title: '最后更新时间', index: 'updated_at' }
      ],
      companyList: [],
      cLoading: false
    }
