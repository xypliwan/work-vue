...
import { getCompanyUser } from '@/api/common'
...
export default {
  ...
  methods: {
    ...
    async getNeedListFilter() {
      this.tableLoading = true
      try {
        let { data } = await getNeedListFilter({
