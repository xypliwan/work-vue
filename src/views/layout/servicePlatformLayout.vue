      ...
      <div slot="header">
        <div class="yc-header">
          <div class="tab">
            <router-link
              tag="div"
              v-if="hasPermissionBtn('question')"
              class="router-item"
              to="/service-platform/submit-work-order"
              >提交工单</router-link
            >
            <router-link
              tag="div"
              v-if="hasPermissionBtn('support')"
              class="router-item"
              to="/service-platform/technical-support"
              >技术支持</router-link
            >
            <router-link
              tag="div"
              ...
              class="router-item"
              to="/service-platform/submit-demand"
              >提交需求</router-link
            >
          </div>
