...
//获取左侧会话聊天窗口数字
export function getChatListNum() {
  return axios({
...
//提交技术评价
export function addSupportInvite(data = {}) {
  return axios({
    url: `/support/tec-sum-by-demand-user`,
    method: 'post',
    data
  })
}
...
//移除工单
export function delChatItem(data = {}) {
  return axios({
    url: `/common/del-chat`,
    method: 'get',
    params: data
...
//标记/取消疑难杂症
export function setMarkProblem(data = {}) {
  return axios({
    url: `/support/mark-problem`,
    method: 'post',
    data
  })
}
...
//标记工单类型(bug/需求)
export function questionUpdateMark(data = {}) {
  return axios({
    url: `/question/update-mark`,
    method: 'post',
    data
  })
}
...
//获取工单列表过滤器
export function getQuestionListFilter() {
  return axios({
...
//添加超时标签
export function addTimeoutTag(data = {}) {
  return axios({
    url: `/question/add-tag`,
    method: 'post',
    data
  })
}
