                ...
                children: [
                    {
                        ...
                        component: () => import("@/views/servicePlatform/submitWorkOrder/index.vue"),
                        meta: {
                            authentication: true,
                            keepAlive: true
                        }
                    },
                    {
                        ...
                        component: () => import("@/views/servicePlatform/technicalSupport/index.vue"),
                        meta: {
                            authentication: true,
                            keepAlive: true
                        }
                    },
                    {
                        ...
                        name: "submit-demand",
                        component: () => import("@/views/servicePlatform/submitDemand/index.vue"),
                        meta: {
                            authentication: true,
                            keepAlive: true
                        }
