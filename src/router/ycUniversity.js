        ...
        children: [
          {
            ...
            name: 'historyBrows',
            component: () =>
              import('@/views/ycUniversity/historyBrows/index.vue'),
            meta: {
              authentication: true,
              keepAlive: true
            }
          },
          {
            ...
            component: () =>
              import('@/views/ycUniversity/knowledgeCenter/index.vue'),
            meta: {
              authentication: true,
              keepAlive: true
            }
          },
          {
            ...
            component: () =>
              import('@/views/ycUniversity/knowledgeManage/index.vue'),
            meta: {
              authentication: true,
              keepAlive: true
            }
          },
          {
            ...
            name: 'videoTutorial',
            component: () =>
              import('@/views/ycUniversity/videoTutorial/index.vue'),
            meta: {
              authentication: true,
              keepAlive: true
            }
